...
Submission
Ignore submission instructions from the autograder, as they are incorrect! In order to submit your project, use the autograder to test your code, and once you're satisfied, upload a zip archive of all the files (not just the ones you edited) on Gradescope.

If you worked with a partner, please specify the name of your partner in a text file called partner.txt. Both you and your partner should submit on Gradescope.
